  ...
  return (
    ...
    <>
      ...
      <div className='privacidade'>
        ...
        <p>
          A sua privacidade é importante para nós. É política do ftrsx respeitar a sua privacidade em relação a qualquer
          informação sua que possamos coletar no site <a href="/vitrine">ftrsx</a>, e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <p>
          ...
          protegemos dentro de meios comercialmente aceitáveis ​​para evitar perdas e roubos, bem como acesso, divulgação, cópia,
        ...
        <p>
          ...
          o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas
          <a href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank" className="privacidade-link"> políticas de privacidade</a>.
        </p>
        <p>
        ...
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o ftrsx oferece no site e com caráter enunciativo, mas não limitativo:
        </p>
        <ul>
          <li>Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
          <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a href='https://bbebbet.br.com' className="privacidade-link">bbebbet</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
          <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do ftrsx, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        ...
        <p>Esta política é efetiva a partir de 5 de Maio de 2024 13:29.</p>
      </div>
      <Footer />
    </>
  );
