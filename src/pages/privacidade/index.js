  ...
  return (
    ...
    <div className='privacidade'>
      ...
      <ul>
        ...
        <li><span style={{ color: 'rgb(68, 68, 68)' }}>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a href='https://bbebbet.br.com' style={{ color: 'inherit', textDecoration: 'none', fontSize: 'inherit' }}>bbebbet</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</span></li>
        <li><span style={{ color: 'rgb(68, 68, 68)' }}>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do ftrsx, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
      </ul>
      ...
      <p>
        <span style={{ color: 'rgb(68, 68, 68)' }}>Esta política é efetiva a partir de&nbsp;5 May 2024 13:29</span>
      </p>
    </div>
